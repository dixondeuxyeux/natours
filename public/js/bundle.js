...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGl4b25kZXV4eWV1eCIsImEiOiJjbDlhNHpmbzMxNzltM3hsbXpzNW96bml4In0.5cGjJbBWZgGgTlm1QtAmdg';
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51LxVmAB7AbIuRSHE6fEAzjyIRikCAbEPNq6sTuZhvybW8vtTEzH2c0KBm7xhRIUN7Q5s37kfIOdFv0OIE34N5X9600wndqe9V0');
...
var editReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(rating, review, reviewId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
if (reviews) reviews.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    ...
    if (button.textContent === 'Delete') {
      ...
      var reviewRatingBox = reviewsCard.querySelector('.reviews__rating');
      ...
      var stars = reviewsCard.querySelectorAll('.reviews__star--active');
